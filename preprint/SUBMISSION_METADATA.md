...
Use the Abstract in `manuscript.md` verbatim in the portal.
...
The manuscript includes a disclosure consistent with bioRxiv’s FAQ: the human author remains accountable, use is described, and the AI system is not listed as an author.
