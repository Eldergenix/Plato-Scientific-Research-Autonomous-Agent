...
then PubMed/Europe PMC/DOAJ/DataCite/OpenCitations/Semantic Scholar for
biomed, open-access, DOI, and identifier-resolution coverage). Order is
cosmetic — the registry keys uniquely on ``adapter.name``.
"""

from . import ads as _ads  # noqa: F401
from . import arxiv as _arxiv  # noqa: F401
from . import crossref as _crossref  # noqa: F401
from . import datacite as _datacite  # noqa: F401
from . import doaj as _doaj  # noqa: F401
from . import europe_pmc as _europe_pmc  # noqa: F401
from . import opencitations as _opencitations  # noqa: F401
