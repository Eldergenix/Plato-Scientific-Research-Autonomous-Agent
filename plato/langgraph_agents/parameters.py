...
class FILES(TypedDict):
    ...
    Paper_folder: str  # name of the folder containing generated paper PDFs
    Error: str  # name of the error file
    module_folder: (
        str  # name of the folder containing the results from the considered module
    )
...
class LITERATURE(TypedDict):
    ...
    max_iterations: (
        int  # maximum number of iterations to perform when searching for papers
    )
